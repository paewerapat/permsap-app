        ...
        <div class="col-md-6">
            ...
            <div class="card p-3 py-4 mx-auto" style="max-width: 400px;">
                ...
                <div class="mb-3 mt-3 d-flex flex-column mx-auto" style="max-width: 400px;">
                    ...
                    <div class="mb-3">
                        <label class="form-label">ชื่อ-สกุล(ในการจัดส่ง)</label>
            ...
            <form id="update-profile" class="modal-content" action="actions/update-profile.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">เบอร์โทรศัพท์</label>
                            <input type="text" class="form-control" value="<?php echo $result['tel'] ?>" name="tel" maxlength="10" disabled required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">ชื่อ-สกุล(ในการจัดส่ง)</label>
                            <input type="text" name="fullname" value="<?php echo $result['fullname'] ?>" class="form-control" disabled required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">ไอดีไลน์</label>
                            <input type="text" name="id_line" class="form-control" value="<?php echo $result['id_line'] ?>" disabled required>
                        </div>
                    </div>
